...
class ChatRoom3 extends React.Component{
    constructor(props){
        super(props);
        ...
        this.newSocket2 = io('localhost:3001/chat3');

        // this.socket = io('localhost:8080');

        this.newSocket2.on('RECEIVE_MESSAGE', function(data){
            addMessage(data);
        });
        ...
        this.sendMessage = ev => {
            ev.preventDefault();
            this.newSocket2.emit('SEND_MESSAGE', {
                    ...
                    <div className="col-6">
                        <div className="card">
                            <div className="card-body">
                                <div className="card-title">ChatRoom 3</div>
                                <hr/>
